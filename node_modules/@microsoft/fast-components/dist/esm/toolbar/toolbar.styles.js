...
import { neutralFillCardRestBehavior, neutralFocusBehavior, neutralOutlineFocusBehavior, } from "../styles/recipes";
/**
...
`.withBehaviors(neutralFillCardRestBehavior, neutralFocusBehavior, neutralOutlineFocusBehavior, forcedColorsStylesheetBehavior(css `
            :host(:${focusVisible}) {
