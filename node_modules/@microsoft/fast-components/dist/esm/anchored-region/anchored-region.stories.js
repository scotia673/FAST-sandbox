    ...
    if (name.toLowerCase().startsWith("anchored-region")) {
        ...
        document
            ...
            el.addEventListener("click", (e) => {
                ...
                positionsRegion.setAttribute(attr, isHorizontal
        ...
        (_a = document
            .getElementById("viewport-scaling-offset")) === null || _a === void 0 ? void 0 : _a.addEventListener("scroll", (e) => {
            const target = e.target;
            regionScalingOffset.updateAnchorOffset(scalingViewportPreviousXValue - target.scrollLeft, scalingViewportPreviousYValue - target.scrollTop);
